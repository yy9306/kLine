...
class HomePage extends Component {
  ...
  render() {
    ...
    return  `<div class="main"><div class="content"><div class="home-page page page-0 slide-enter-right"><div class="top-area"><div class="total">微信（500）</div><div class="actions"><ul class="icons"><li class="icon icon-search"></li><li class="icon icon-add"></li></ul></div></div><div class="list-view router"><ul class="lists">${listView}</ul><div class="add" data-click={add("add")}>添加</div></div>
